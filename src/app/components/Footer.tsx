        ...
        <div style={{
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "24px" }}>
              ...
              <div>
                ...
                <span style={{ fontFamily: "Poppins, sans-serif", fontWeight: 700, color: "#C41230", fontSize: "16px" }}>
                  PRESTANCE
                </span>
              </div>
            </div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "12px" }}>
              {quickLinks.map((link) => (
                <li key={link}>
                  <a
                    href={navIds[link]}
                    onClick={(e) => { e.preventDefault(); handleScroll(navIds[link]); }}
                    style={{
                      fontFamily: "Inter, sans-serif", fontSize: "14px",
          ...
          <div>
            ...
            <p style={{
              ...
              color: "rgba(255,255,255,0.45)", lineHeight: 1.6, marginBottom: "16px",
            }}>
              Conseils visuels et actualités du cabinet directement dans votre boîte mail.
            </p>
            <div style={{ display: "flex" }}>
              ...
              <button
                style={{
                  backgroundColor: "#C41230", color: "#fff", border: "none",
                  padding: "12px 16px", cursor: "pointer", flexShrink: 0,
                  transition: "background-color 0.2s",
                }}
                onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#a00f27")}
